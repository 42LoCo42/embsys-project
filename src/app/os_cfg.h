...
#define OS_CFG_PRIO_MAX                 32u                /* DUC: Defines the maximum number of task priorities (see OS_PRIO data type) */

#define OS_CFG_SCHED_LOCK_TIME_MEAS_EN  DEF_DISABLED       /* Include (DEF_ENABLED) code to measure scheduler lock time             */
#define OS_CFG_SCHED_ROUND_ROBIN_EN     DEF_DISABLED       /* DUC: Include (DEF_ENABLED) code for Round-Robin scheduling                 */
